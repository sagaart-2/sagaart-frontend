...
import type { ICreateUserForm } from '@/shared/types';

interface ISignUpFormUi {
  form: UseFormReturnType<ICreateUserForm>;
  handleSubmit: () => void;
}

export function UserSignUpFormUi({ form, handleSubmit }: ISignUpFormUi) {
  return (
